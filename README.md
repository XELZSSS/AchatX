...
<h1>Orlinx</h1>
  ...
  <p>Orlinx is a desktop AI chat client built on a cross-platform stack.</p>
</div>
...
- Special note: When using Gemini CLI OAuth, get the login credentials from the console and place them in `orlinx.local.json`.

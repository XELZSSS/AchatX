...
const ChatBubble: React.FC<ChatBubbleProps> = ({
  ...
  return (
    <div className={`flex w-full mb-6 justify-center ${animateOnMount ? 'fx-soft-rise' : ''}`}>
      <div
            ...
            {isUser ? (
              ...
              <div className="min-w-0">
                ...
                {hasReasoning && isReasoningOpen && (
                  <div className="mb-3 w-fit max-w-[min(40rem,100%)] rounded-lg border border-[var(--line-1)] bg-[var(--bg-2)] px-3 py-2 text-xs text-[var(--ink-3)]">
